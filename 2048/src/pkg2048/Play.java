...
public class Play extends BasicGameState{
    ...
    int c1=0,c2=0,c3=0,holdNum=0,end=1,endCounter=0;
    boolean spawn=false,keyPress=false,keyPressUp=false,keyPressDown=false,keyPressRight=false,keyPressLeft=false,exitConfirmation=false;
